...
window.addEventListener('DOMContentLoaded', function () {
  ...
  callButton.addEventListener('click', function () {
    ...
    modalClosedButton.addEventListener('click', modalClose); // modalFormSubmitButton.addEventListener('click', modalClosed);
  });
  ...
  try {
    var _loop = function _loop() {
      ...
      button.addEventListener('click', function (event) {
        var accordionBody = event.target.closest('.accordion').querySelector('.accordion__body');
        ...
        if (button.classList.contains('accordion__button_closed')) {
          ...
          var _iterator3 = _createForOfIteratorHelper(accordions),
              _step3;
