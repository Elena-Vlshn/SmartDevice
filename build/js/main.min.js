...
window.addEventListener('DOMContentLoaded', function () {
  ...
  function trapFocus(e) {
    ...
    var focusableFormEls = modal.querySelector('.form').querySelectorAll('button:not([disabled]), textarea:not([disabled]), input[type="text"]:not([disabled]), input[type="tel"]:not([disabled]), input[type="checkbox"]:not([disabled]), textaria');
    var firstFocusableEl = focusableFormEls[0];
    var lastFocusableEl = focusableFormEls[focusableFormEls.length - 1];
